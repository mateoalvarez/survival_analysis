...
\section{Results}
  ...
  \subsection{Survival Analysis}
    ...
    Among the collection of methods included under Survival Analysis, three groups have to be taken into account: non-, semi- and parametric models. This classification responds to the assumption about the shape of the \emph{hazard rate function}, and implies the complexity of the model itself, as

    , two have special interest for different reasons, these two models are introduced here and explained in detail below.
